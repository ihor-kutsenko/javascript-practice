...
// з масиву numbers, а в змінній oddNumbers - масив непарних.Обов'язково використовуй метод filter().
...
// *Example #3
//==================================================================================================================
// Доповни функцію getUsersWithEyeColor(users, color) таким чином, щоб вона повертала масив користувачів, у яких колір очей
//     (властивість eyeColor) збігається зі значенням параметра color.
const users = [
  {
    name: "Moore Hensley",
...
const getClientssWithAge = (clients, minAge, maxAge) => {
  return clients.filter(({ age }) => age >= minAge && age <= maxAge);
};
console.log(getClientssWithAge(clients, 20, 30));
